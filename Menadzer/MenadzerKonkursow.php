...
<body>
    ...
    <main>
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            } else if (strlen($nazwa) > $nazwa_konkurs_dlugosc) {
        ...
        echo "<table>";
        echo "<tr><th>Nazwa</th><th>Lokacja</th><th>Termin zgłoszeń</th><th>Status</th></tr>";
        while ($row = pg_fetch_array($query)) {
            ...
            echo "<tr><td>" . $row['nazwa'] . "</td><td>" . $rowKraj['nazwa'] . "</td><td>" . $row['termin_zgloszen'] . "</td><td>" . $row['status_konkursu'] . "</td></tr>";
        }
        echo "</table>";
        pg_close($conn);
        ?>
